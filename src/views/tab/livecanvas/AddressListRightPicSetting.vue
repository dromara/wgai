  ...
  export default {
    ...
    methods: {
      ...
      edit(record) {
        ...
        console.log(" record.videoId",  this.model.videoId )
        console.log(" record.id",this.model.id )
        let that = this;
        getAction("/video/tabVideoUtil/getVideoPicSetting", {
          ...
          if (res.success) {
            ...
            console.log(res)
            that.$message.warning("未获取到重新设置");

          }
          console.log("this.model.videoId",this.model.videoId)
      ...
      startRecording() { //确认配置
        ...
        this.$confirm({
          ...
          onOk: function() {
            ...
            let method = '';
            //  debugger;
            httpurl = '/video/tabVideoUtil/saveBoxSetting';
            method = 'post';
