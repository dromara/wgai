<template>
 ...
 <div class="contable">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" class="dc" @click="handleExportXls('训练结果')">导出</a-button>
    ...
    <tab-train-result-modal class="contc" :width="1200" ref="modalForm" @ok="modalFormOk"></tab-train-result-modal>
    </div>
  </a-card>
</template>
