<template>
 ...
 <div class="contable">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" class="dc" @click="handleExportXls('数字人动作')">导出</a-button>
    ...
    <tab-szr-dz-modal class="contc" :width="1200" ref="modalForm" @ok="modalFormOk"></tab-szr-dz-modal>
    </div>
  </a-card>
</template>
