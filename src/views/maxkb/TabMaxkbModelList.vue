<template>
 ...
 <div class="contable">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" class="dc" @click="handleExportXls('语言模型列表')">导出</a-button>
    ...
    <tab-maxkb-model-modal class="contc" :width="1200" ref="modalForm" @ok="modalFormOk"></tab-maxkb-model-modal>
    </div>
  </a-card>
</template>
