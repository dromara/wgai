...
<script>
  ...
  import TabChatTypeModal from './modules/TabChatTypeModal'

  export default {
    name: 'TabChatTypeList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/chat/tabChatType/list",
          delete: "/chat/tabChatType/delete",
          deleteBatch: "/chat/tabChatType/deleteBatch",
          exportXlsUrl: "/chat/tabChatType/exportXls",
          importExcelUrl: "chat/tabChatType/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'sendSum',text:'数量',dictCode:''})
